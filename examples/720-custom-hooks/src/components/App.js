	...
	return (
		<div className="container">
			...
			<div className="row">
				<div className="col">
					<hr/>
					{/*A standard component with local state - no hooks used */}
					<CounterStep1/>
					<hr/>
					{/*A component that uses a custom hook. It is initialized twice,*/}
					{/*with different values. */}
					<CounterStep2/>
					{/*Another component with a custom hook.*/}
					{/*It uses localStorage to persist the value of the state.*/}
					{/*<hr/>*/}
					{/*<CounterStep3/>*/}
				</div>
			</div>
